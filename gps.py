...
fmap = folium.Map(location=[24.968236, 121.195269], zoom_start=17)
for point in os.listdir('data/'):
    ...
    for i in SV.keys():
        ...
        fmap.add_child(folium.PolyLine(locations=[origin_point, [end_lat, end_lon]], color=color_dict[round(snr/(50/len(color_dict)))]))
